...
namespace Kalend
{
    ...
    public class ClipSelector : AudioSelection
    {
        ...
        [Range(0.5f, 30f)]
        public float fadeTime = 10f;//This is the duration of the lerp used to fade audio. 

        private float _currentClipLength = 5f;  //5 is just a place holder to avoid being initiated as zero (becuase it is used as a denominator).
